import numpy as np
import quaternion  # Make sure to install this package: pip install numpy-quaternion
...
def main():
    ...
    dt = 0.01  # 10 milliseconds
    
    # Example gyroscope measurement in radians per second
    omega_meas = np.array([0.1, -0.05, 0.2])
    
    # Update the orientation with the measurement.
    ...
    print("As float array:", quaternion.as_float_array(q))
